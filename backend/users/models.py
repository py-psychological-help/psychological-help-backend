    ...
    def image_resize(self, width, height):
        ...
        with Image.open(image) as img:
            ...
            if ((img.width > width or img.height > height)
                ...
                # Create a new resized “thumbnail” ver of the image with Pillow
                ...
                # Save the resized image in the buffer, noting the correct file
                # type
                buffer = BytesIO()
                ...
                image.save(img_filename, file_object, save=False)
